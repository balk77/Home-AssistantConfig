...
class masterslavezolder(hass.Hass):
    def initialize(self):
        ...
        self.listen_state(self.masterslavezolder, self.args["ventipv"])
        self.listen_state(self.masterslavezolder, self.args["thermpv"])
        #self.listen_state(self.inputhandler_state, self.args["roomsp"])

    def masterslavezolder(self, entity, attribute, old, new, kwargs):
